...
function RegistroBandeja() {
  ...
  useEffect(() => {
    const cargarProcedimientos = async () => {
      try {
        const response = await fetch('http://localhost/hackaton.github.io/hackaton/src/backend/obtener_procedimientos.php');
        if (!response.ok) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost/hackaton.github.io/hackaton/src/backend/registrar_bandeja.php', {
        method: 'POST',
        headers: {
              ...
              <div className="instrumento-form">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => handleInstrumentoChange(index, 'nombre', e.target.value)}
                ...
                <div className="form-group cantidad">
                  ...
                  <input
                    ...
                    onChange={(e) => handleInstrumentoChange(index, 'cantidad', parseInt(e.target.value) || 1)}
                    min="1"
                    className="form-control"
                    required
                  />
